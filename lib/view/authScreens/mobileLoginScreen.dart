      ...
      child: Scaffold(
        body: ListView(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                context.read<MobileAuthprovider>().updateMobileNumber(
                  '$selectedCountry${mobileContoller.text.trim()}',
                );
                MobileAuthServices.receiveOTP(
                  context: context,
                  mobileNo: '$selectedCountry${mobileContoller.text.trim()}',
                );
              },
            ...
            SizedBox(height: 3.h),
            Text(
              'By proceeding, you consent to get calls, Whatsapp or SMS messages, including by automated means, from uber and its affiliated to the number provided.',
              style: AppTextStyles.body14.copyWith(color: Colors.grey),
            ),
            SizedBox(height: 2.h),
            SizedBox(height: 2.h),
            Row(
